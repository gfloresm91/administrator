...
namespace Administrator.Identity.Errors
{
    public class SpanishIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        public override IdentityError InvalidToken()
        {
            return new IdentityError
            {
                ...
                Description = "Ha ingresado un código incorrecto."
            };
        }
        ...
        public override IdentityError InvalidUserName(string userName)
        {
            return new IdentityError
            {
                ...
                Description = $"El nombre de usuario '{userName}' es incorrecto. Solo puede contener letras y números."
            };
        }
        ...
        public override IdentityError DuplicateEmail(string email)
        {
            return new IdentityError
            {
                ...
                Description = $"La direccion de email '{email}' ya se encuentra registrada. Pruebe recuperar su contraseña para ingresar nuevamente al sistema."
            };
        }
        public override IdentityError InvalidRoleName(string role)
        {
            return new IdentityError
            {
                ...
                Description = $"El nombre de rol '{role}' es incorrecto."
            };
        }
        ...
        public override IdentityError PasswordTooShort(int length)
        {
            return new IdentityError
            {
                ...
                Description = $"La contraseña debe tener un largo mínimo de {length} caracteres."
            };
        }
